...
void KMClassifierEvaluation::WriteClustersGravityCenters(ostream& ost) {
	...
	// NB. le numero de cluster affich� apr�s le tri, doit rester inchang�
	...
	for (int idxCluster = 0; idxCluster < clusters->GetSize(); idxCluster++) {
		...
		// affichage des probas des modalit�s de la valeur cible
		// NB. ces probas sont issues de l'apprentissage OU du dico de modelisation, et non de l'evaluation elle m�me
