	...
	KWPredictorEvaluation* requesterPredictorEvaluation)
{
	...
	odAttributesPartitions = cast(ObjectDictionary*, &kmEvaluationClustering->GetAttributesPartitioningManager()->GetPartitions());
	odAtomicModalities = cast(ObjectDictionary*, &kmEvaluationClustering->GetAttributesPartitioningManager()->GetAtomicModalities());
