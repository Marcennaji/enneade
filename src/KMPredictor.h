...
public:
	...
	/** evaluer la memoire  necessaire pour traiter n instances en base de donnees, a l'aide du dico passé en parametre */
...
protected:
	...
	/** ajout des attributs necessaires a la production des rapports de frequences de modalités, et des levels de clustering */
	...
	/** meilleur resultat de clustering observé lors de l'apprentissage */
