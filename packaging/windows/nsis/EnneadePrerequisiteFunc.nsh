...
!ifndef DO_NOT_INSTALL_REQUIREMENTS
  ...
  ${If} $0 == 1
      Messagebox MB_OK "Could not install MPI runtime (version ${MPIRequiredVersion}): Enneade will not run. Try installing Microsoft MPI directly before installing Enneade." /SD IDOK
  ${EndIf}
!endif
FunctionEnd
